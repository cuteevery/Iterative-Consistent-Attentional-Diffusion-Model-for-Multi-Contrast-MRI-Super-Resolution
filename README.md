...
python sr.py -p train -c config/IXI.json
python sr.py -p train -c config/fastmri_train.json
```
...
python sr.py -p val -c config/IXI_val.json
python sr.py -p val -c config/fastmri_train.json
